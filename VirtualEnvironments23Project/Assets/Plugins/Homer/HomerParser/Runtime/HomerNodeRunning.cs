...
namespace Homer
{
    public class HomerNodeRunning
    {
        ...
        public HomerElement GetTextElement()
        {
            ...
            {
                case CycleType.list:
                    element = availableElements.Count > 0 ? availableElements[0] :
                        Node._elements[Node._elements.Length - 1];
                    element._visited = true;
                    break;

                case CycleType.smartRandom:
                    availableElements = availableElements.Count > 0 ? availableElements :
        ...
        public string ParsedText(HomerElement element)
        {
            if (element == null)
                return "";
        ...
        public string GetParsedText(HomerElement element = null)
        {
            if (element == null)
                element = GetTextElement();

            string parsedText = ParsedText(element);
